...
<form id="manage_ticket" class="needs-validation"   action="./proceso_departamento/proceso_guardar.php" enctype="multipart/form-data" method="post">
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label id="form_departamento" for="validationTooltip01">Departamento</label>
      <input type="text" class="form-control" id="validationTooltip01" placeholder="Departamento" name="sede" value=""  >
    </div>
    <div class="col-md-3 mb-2">
      <label id="form_telefono"  for="validationCustom02">  Telefono  </label>
        <input type="number"   class="form-control" id="validationCustom02" placeholder="Telefono" name="telefono" value=""  >
    </div>
    <div class="col-md-3 mb-2">
      <label id="form_ext"  for="validationCustom02">  Extencion  </label>
        <input type="number"   class="form-control" id="validationCustom02" placeholder="Extencion" name="ext" value=""  >
    </div>
    <div class="col-md-3 mb-2">
